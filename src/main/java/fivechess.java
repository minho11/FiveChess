...
public class fivechess {
    ...
    Chess_board chess_board=new Chess_board(this);
    ...
    private void init() {
        ...
        try {
            table=ImageIO.read(new File("/Users/xiayi/Documents/java_text/src/五子棋棋盘/image/board.jpg"));
            black=ImageIO.read(new File("/Users/xiayi/Documents/java_text/src/五子棋棋盘/image/black.gif"));
            white=ImageIO.read(new File("/Users/xiayi/Documents/java_text/src/五子棋棋盘/image/white.gif"));
            select=ImageIO.read(new File("/Users/xiayi/Documents/java_text/src/五子棋棋盘/image/selected.gif"));
        } catch (IOException e) {
            e.printStackTrace();
        }
